export default function Profile() {
  return (
    <>
      <div className="h-screen w-screen bg-slate-400 flex items-center justify-center gap-8 relative">
        {/* <img
        ...
        {/* First profile cart */}
        <div className="z-10 w-56 h-72 bg-slate-50 bg-opacity-10 backdrop-blur-md rounded-lg flex flex-col items-center border border-slate-50/40">
          <div className="border-slate-50/40 border-2 bg-slate-50 bg-opacity-50 backdrop-blur-md w-20 h-20 rounded-full mt-4 items-center justify-center flex">
            <img src="ganzo.jpg" className=" w-16 h-16 rounded-full" />
          </div>
          <h1 className=" font-bold text-slate-50">Ganzorig.U</h1>
          <div className=" text-sm text-slate-50">Programmist</div>
        ...
        <div className="z-10 w-56 h-72 bg-slate-50 bg-opacity-10 backdrop-blur-md rounded-lg flex flex-col items-center border border-slate-50/40">
          ...
          <div className=" relative w-full h-full flex justify-center mt-12">
            <button className="  bg-slate-50 text-sm bg-opacity-10 backdrop-blur-md  text-slate-50 w-1/2 py-1">
              95% <div> Rating</div>
            </button>
            <button className="bg-slate-50 text-sm bg-opacity-10 backdrop-blur-md  text-slate-50 w-1/2 py-1">
              92%<div> Activity</div>
